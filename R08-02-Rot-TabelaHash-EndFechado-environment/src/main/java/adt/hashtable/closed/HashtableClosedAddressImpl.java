...
public class HashtableClosedAddressImpl<T> extends AbstractHashtableClosedAddress<T> {
	...
	private LinkedList<T> indexList(T element) {
		int elementPosition = ((HashFunctionClosedAddress<T>) hashFunction).hash(element);
		return (LinkedList<T>) table[elementPosition];
	}
