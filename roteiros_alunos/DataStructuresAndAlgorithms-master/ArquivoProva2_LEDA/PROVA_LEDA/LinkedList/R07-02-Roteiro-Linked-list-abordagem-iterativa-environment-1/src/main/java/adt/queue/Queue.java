...
public interface Queue<T> {
	...
	/**
	 * Inserts a new element in the queue or returns an exception if the queue is full.
	 * Null elements are not allowed (the queue remains unchanged). 
	 * @param element
	...
	/**
	 * Returns (without removing) the oldest element of the stack or null if the queue 
	 * is empty. 
	 * @return
	 */
	public T head();
