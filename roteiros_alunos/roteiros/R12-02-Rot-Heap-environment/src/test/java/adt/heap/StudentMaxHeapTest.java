...
public class StudentMaxHeapTest {
	...
	@Test
	public void testElementsByLevel() {
		heap.insert(8);
		heap.insert(12);
		heap.insert(-2);
		heap.insert(7);
		...
		assertEquals(10, heap.size());
		assertFalse(heap.isEmpty());
		Integer[] array = new Integer[] { 7, 8, -5, -2 };
		assertEquals(Arrays.toString(array), Arrays.toString(((HeapImpl<Integer>) heap).elementsByLevel(2)));
		Integer[] array2 = new Integer[] { 8, 12 };
		assertEquals(Arrays.toString(array2), Arrays.toString(((HeapImpl<Integer>) heap).elementsByLevel(1)));
		Integer[] array3 = new Integer[] { 14 };
		assertEquals(Arrays.toString(array3), Arrays.toString(((HeapImpl<Integer>) heap).elementsByLevel(0)));
		Integer[] array4 = new Integer[] { 3, -10, 0, null, null, null, null, null };
		assertEquals(Arrays.toString(array4), Arrays.toString(((HeapImpl<Integer>) heap).elementsByLevel(3)));
	}
