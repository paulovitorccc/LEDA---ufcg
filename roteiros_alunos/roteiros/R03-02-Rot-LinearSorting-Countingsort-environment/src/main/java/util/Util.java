...
public class Util {
	...
	public static Integer retornaMaior(Integer[] v, int leftIndex, int rightIndex) {

		Integer maior = v[leftIndex];
	...
	public static Integer retornaMenor(Integer[] v, int leftIndex, int rightIndex) {

		Integer menor = v[leftIndex];
