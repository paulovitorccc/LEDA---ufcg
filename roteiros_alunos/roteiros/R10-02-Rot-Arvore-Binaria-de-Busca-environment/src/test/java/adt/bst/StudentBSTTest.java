...
public class StudentBSTTest {
	...
	@Test
	public void testBstIgual(){
		BSTImpl<Integer> arvore1 = new BSTImpl<>();
		Integer[] array = { 6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40 };
		for (int i : array) {
			arvore1.insert(i);
		}
		BSTImpl<Integer> arvore2 = new BSTImpl<>();
		Integer[] array2 = { 6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40 };
		for (int j : array2) {
			arvore2.insert(j);
		}
		assertTrue(tree.comparaBst(arvore1,arvore2));
		arvore2.insert(240);
		assertFalse(tree.comparaBst(arvore1,arvore2));
	...
	public void testCountLevels(){
		...
		fillTree();
		assertEquals(5,tree.countLevels());
		
	}

	@Test
	public void testSizeAnt(){
		fillTree();
	...
	public void testSum(){
		fillTree();
		assertEquals(358,tree.sum());
		tree.remove(232);
		assertEquals(126,tree.sum());
		tree.remove(6);
		assertEquals(120,tree.sum());
